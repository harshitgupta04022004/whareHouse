...
Prompts for building shared React components.

## Files in This Directory
1. `02-app-shell-navigation-rbac.md` — App shell with RBAC-aware navigation, warehouse switcher

## Context
These prompts build on:
- `AuthProvider.tsx` (this directory: `../AuthProvider.tsx`)
- `Navbar.tsx` (this directory: `../Navbar.tsx`)
- RBAC middleware (`../../api/prompts/02-rbac-middleware-warehouse-guard.md`)

## Design References
- Navigation: [MDN Navigation Patterns](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/nav)
