...
Prompts for building authentication screens in the `(auth)` route group.

## Files in This Directory
1. `01-auth-login-signup-ui.md` — Login/signup forms with Supabase Auth
2. `11-password-reset-forgot-flow.md` — Password reset via email flow
3. `12-error-boundary-loading-skeletons.md` — Error boundaries and loading skeletons

## Context
These prompts build on:
- `AuthProvider.tsx` (parent: `../../components/AuthProvider.tsx`)
- Supabase Auth client (backend: `../../api/prompts/01-supabase-auth-session-api.md`)
- Database users table (schema: `../../database/prompts/02-app-users-auth-link.md`)

## Design References
- Forms: [MDN Form Best Practices](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Forms)
- Colors: [Color Hunt — Industrial Warehouse](https://colorhunt.co/palette/2c3333395b64a5c9cae7f6f2)
